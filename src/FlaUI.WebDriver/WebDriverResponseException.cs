...
namespace FlaUI.WebDriver
{
    public class WebDriverResponseException : Exception
    {
        ...
        public static WebDriverResponseException NoSuchWindow(string windowHandle) => new WebDriverResponseException($"No window found with handle {windowHandle}", "no such window", 404);
    }
}
